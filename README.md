...
- [deeper-cli-windows-x86_64-0.2.4.zip](https://deeper-network.s3.amazonaws.com/deeper-cli/deeper-cli-windows-x86_64-0.2.4.zip)
- [deeper-cli-linux-x86_64-0.2.4.tar.gz](https://deeper-network.s3.amazonaws.com/deeper-cli/deeper-cli-linux-x86_64-0.2.4.tar.gz)
- [deeper-cli-linux-armv7-0.2.4.tar.gz](https://deeper-network.s3.amazonaws.com/deeper-cli/deeper-cli-linux-armv7-0.2.4.tar.gz
)
- [deeper-cli-apple-darwin-x86_64-0.2.4.tar.gz](https://deeper-network.s3.amazonaws.com/deeper-cli/deeper-cli-apple-darwin-x86_64-0.2.4.tar.gz
)
